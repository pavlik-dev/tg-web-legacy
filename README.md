...
## Webogram Legacy — Telegram Web App
...
<!--All of the apps above are submitted and **NO LONGER** maintained by [@zhukov](https://github.com/zhukov), so feel free to use them and report bugs [here](https://github.com/zhukov/webogram/issues), and they'll be ignored. Please do not report bugs which are only reproducible in different locations.-->
